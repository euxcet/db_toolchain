...
class QuatGestureTrainer(Trainer):
  def __init__(self, **kwargs):
    super(QuatGestureTrainer, self).__init__(**kwargs)

  def init_dataset(self):
    self.dataset = get_quat_gesture_dataset(self.dataset_path)
  ...
  def init_model(self):
    self.model = FullyConnectedModel(num_classes=self.num_classes)
