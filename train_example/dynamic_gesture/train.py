...
from train_example.dynamic_gesture.bak_imu_gesture_dataset import get_imu_gesture_dataset

from db_train.src.db_train.trainer import Trainer, add_argument
from db_train.src.db_train.metric import MetricGroup, CrossEntropyLoss, AccuracyMetric, ConfusionMatrixMetric

class DynamicGestureTrainer(Trainer):
  def __init__(self, **kwargs):
    super(DynamicGestureTrainer, self).__init__(**kwargs)
...
if __name__ == '__main__':
  ...
  DynamicGestureTrainer(**vars(args)).train()
